...
\thesistitle{Received signal strength-inertial sensor based fingerprinting localization in indoor wireless environments} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
In this work a new indoor localization system is proposed, combining fingerprinting and range-based approaches. We propose a machine learning fingerprint approach for room recognition and a range-based weighted trilateration method for localization. The weights for the trilateration are defined by considering information provided by the room recognition approach.

We test our localization approach in a complex indoor scenario on the third floor of the institute of Computer Science at the University of Bern. Results show that our room recognition approach achieves accuracies of 80-90\%. Moreover, our weighting method improves the localization by 12\% over non-weighted trilateration. It does, however, not perform better than existing simpler weighting methods.

\begin{acknowledgements}
\addchaptertocentry{\acknowledgementname} % Add the acknowledgements to the table of contents

\noindent I would like to thank Jose Carrera for supervising this thesis and his support on various occasions during my work on this thesis.

Further thanks go to Viviane Tanner and Martina Föhn for their individual support on this thesis.
...
\textbf{PDR} & \textbf{P}edestrian \textbf{D}ead \textbf{R}eckoning\\
...
\textbf{STD} & \textbf{S}tandard \textbf{D}ev\textbf{i}ation\\
