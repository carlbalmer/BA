...
In this work a new indoor localization system is proposed, combining fingerprint and range-based approaches. We propose a machine learning approach for room recognition and a range-based weighted trilateration method for localization. The weights for the trilateration are defined by considering information provided by the room recognition approach.
