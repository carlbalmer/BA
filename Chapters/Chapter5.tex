...
\decoRule
\caption[Weighting method comparison]{CDF of the Localization error with the \emph{Room Weights}.}
...
\decoRule
\caption[Weighting method comparison]{CDF of the Localization error with the \emph{combined room and distance weights}.}
