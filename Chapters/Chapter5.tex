...
\decoRule
\caption[Collected Data Sets]{Illustration showing the collected data sets. (blue) \emph{XY} data set with exact coordinates, (green) \emph{Grid} data set, (red)\emph{Borders} data set.}
\label{fig:DataSets}
\end{figure}
